...
;(function(){
	...
	$.fn.customSelect = function( options ) {
		...
		var _click = function(e) {
			...
			// if we click on cross for remove selected
			if($target.hasClass("fa")) {
				console.log("ds");
				_clickOnCross($target, e);
			}
		};
		...
		// if we click on cross
		function _clickOnCross(element, e) {
			console.log(element);
			var $selectedArea = element.parent(".custom-select__selected");
			var index = $selectedArea.data("index");
